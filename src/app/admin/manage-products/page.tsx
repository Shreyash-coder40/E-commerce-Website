    ...
    <div className="min-h-screen bg-slate-950 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden flex items-center justify-center font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <div className="w-full max-w-6xl mx-auto relative z-10">
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-black text-white tracking-tight">Manage Inventory</h1>
            <p className="text-sm text-slate-400 mt-1">Modify prices, track stock levels, or remove active products.</p>
          </div>
          <Link
            href="/"
