...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      specifications: {
        "Model Name": "PlayStation 5 Slim",
        "Storage Capacity": "1 TB SSD",
        "Color": "White",
        "Resolution Support": "4K 120Hz",
        "HDR Support": "Yes",
        "Weight": "3.2 kg",
      },
    },
    {
      ...
      description: "Smarter. Brighter. Mightier. The most powerful chip in Apple Watch ever. A magical new way to use your watch without touching the screen. A display that's twice as bright.",
      price: 41900,
      mrp: 44900,
      category: "Wearables",
      stock: 18,
    ...
    },
    {
      ...
      description: "An icon remastered. MX Master 3S wireless mouse features Quiet Clicks, 8K DPI track-on-glass sensor, MagSpeed electromagnetic scrolling, and custom profiles for app-specific actions.",
      price: 9495,
      mrp: 10995,
    ...
    },
    {
      ...
      warranty: "1 Year Kindle Limited Warranty",
      specifications: {
        "Model Name": "Kindle Paperwhite 11th Gen",
